  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (session?.access_token) {
        // Create host profile with 14-day trial
  ...
  return (
    <div style={pageStyle}>
      <div style={cardStyle}>
        ...
        <h1 style={headingStyle}>Start your free trial</h1>
        <p style={{ textAlign: "center", color: "#666", fontSize: "14px", margin: "-16px 0 24px" }}>
        ...
        <p style={{ textAlign: "center", color: "#666", fontSize: "14px", marginTop: "12px" }}>
          ...
          <Link to="/host/login" style={{ color: "#1A3A4A", fontWeight: 600 }}>
            Log in
          </Link>
        </p>
      </div>
