      ...
      <section className="bg-[var(--color-deep)] pb-16 pt-40 text-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <p className="mt-4 max-w-xl text-white/75">
            No bots, no delays. Reach out for custom requests, special occasions, extended stays —
            or just to ask which property is right for your trip.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div className="rounded-md border border-border bg-card p-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Skip the platform fees and unlock the returning-guest discount.
            </p>
            <a
          ...
          <div className="rounded-md border border-border bg-card p-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Send a message through our booking site and we&apos;ll get right back to you — usually
              within the hour.
            </p>
            <a
              href={BOOK_DIRECT_URL}
