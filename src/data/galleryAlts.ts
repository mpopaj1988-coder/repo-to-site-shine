...
export const galleryManifest: Record<string, GalleryEntry[]> = {
  ...
  largo: [
    ...
    // 4. DECISION: designer kitchen with gray cabinetry and rattan stools — pull up from position 13
