...
export const WIFI_CONFIG: Record<string, PropertyHouseInfo> = {
  ...
  "stpete-sunsoaked": {
    ...
    notes: [
      ...
      "Stovetop: always place a pot or pan on the burner for it to activate. Not clicking? Make sure the lock button is not on.",
      "Stovetop showing 'LO'? The fuse has tripped — go outside the apartment door, open the electric panel on your left (may be behind a portrait), flip the main switch (last on panel) OFF then back ON.",
      "Quiet hours: 10 PM – 7 AM.",
