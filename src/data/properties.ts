...
const galleryModules = import.meta.glob("@/assets/properties/*/*.{jpg,jpeg,png}", {
  eager: true,
  query: { format: "webp", quality: "80", w: "1920", as: "url" },
  import: "default",
...
const data: Omit<Property, "image" | "images" | "imageAlts">[] = [
  {
    ...
    description:
      "Waterfront Tampa vacation rental with heated pool, private dock and two master suites — sleeps 15 in luxury. Book direct and save.",
    bedrooms: 6,
    bathrooms: 4,
    sleeps: 15,
    feature: "Pool + Dock",
    ...
    highlights: [
      { icon: "🛥️", title: "Private dock", body: "Step right onto the water from your backyard." },
      {
        icon: "🏊",
        title: "Heated pool",
        body: "Resort-style pool deck with seating for the group.",
      },
      {
        icon: "👨‍🍳",
        title: "Chef kitchen",
        body: "Gourmet kitchen with island, ideal for cooking together.",
      },
    ],
  },
  {
    ...
    description:
      "Largo pool home 5 minutes from Indian Rocks Beach — heated pool, lit gazebo, fire pit and 3 spa baths. Sleeps 11. Book direct.",
    bedrooms: 3,
    bathrooms: 3,
    sleeps: 11,
    feature: "Heated Pool",
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/f4aa7002-c774-5f9f-bda5-07da36ac4224",
    ...
    amenities: [
      ...
      "Lit gazebo + dining for 4",
      "Fire pit",
      "Outdoor patio + couch",
      "BBQ grill",
      "Three spa-style baths",
      "Quartz chef kitchen",
      "Smart TVs",
      "Fast Wi-Fi",
      "Washer & dryer",
    ...
    highlights: [
      {
        ...
        body: "Heated pool with stunning waterfall feature.",
      },
      {
        icon: "🔥",
        title: "Fire pit + gazebo",
        body: "Lit gazebo and Adirondack fire circle for evenings.",
      },
  ...
  },
  {
    ...
    description:
      "Walk to Indian Rocks Beach in seconds — 2BR coastal home with private hot tub, sunny deck and beach gear included. Sleeps 6.",
    bedrooms: 2,
    bathrooms: 2,
    sleeps: 6,
    feature: "Hot Tub",
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/d6509a01-5557-50cd-b5bd-2e9db649f1c3",
  ...
  },
  {
    ...
    description:
      "4BR Clearwater pool home, 9 minutes to the beach — heated pool, fire pit, fenced yard and bunk room. Sleeps 14. 283+ five-star stays.",
    bedrooms: 4,
    bathrooms: 2,
    sleeps: 14,
    feature: "Heated Pool",
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/47118bd2-8b40-5d57-a2e2-9dca8557177f",
  ...
  },
  {
    ...
    description:
      "Steps from Indian Rocks Beach — 2BR Gulf-side home with private hot tub, sunset deck and Insta-ready interiors. Sleeps 6.",
    bedrooms: 2,
    bathrooms: 2,
    sleeps: 6,
    feature: "Hot Tub",
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/845626c9-0ff3-5e54-b949-500d0d23ae1f",
    ...
    highlights: [
      {
        ...
        body: "Enclosed spa with neon sign and string lights.",
      },
  ...
  },
  {
    ...
    description:
      "Walk to downtown St. Pete — light-filled 2BR designer condo with two king beds, sleeps 6. Steps to Central Ave restaurants and Crescent Lake.",
    bedrooms: 2,
    bathrooms: 1,
    sleeps: 6,
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/119e8731-1dec-5f42-ad4d-c62951cb0b37",
    ...
    amenities: [
      "Two king beds + sofa bed",
      "Designer interiors",
      "Walk to Central Ave",
      "Walk to Crescent Lake",
      "Updated kitchen",
      "Premium linens",
      "Smart TV",
      "Fast Wi-Fi",
  ...
  },
  {
    ...
    description:
      "Editorial 1BR St. Pete retreat with king bed, private balcony and chef kitchen — minutes to the waterfront. Adults-only escape for 2.",
    bedrooms: 1,
    bathrooms: 1,
    sleeps: 2,
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/91ba6ef0-48c1-5fa2-a98c-20b9079cdec9",
  ...
  },
  {
    ...
    description:
      "St. Pete bungalow with private outdoor hot tub, bamboo garden and BBQ — sleeps 4, walk to downtown. King bed plus sofa bed.",
    bedrooms: 1,
    bathrooms: 1,
    sleeps: 4,
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/6c832fe5-90a4-51eb-b382-13bb35b2c139",
  ...
  },
  {
    ...
    description:
      "Bold St. Pete 1BR with statement art, dartboard game room and 3 beds — sleeps 6. Walk to downtown nightlife and Central Ave.",
    bedrooms: 1,
    bathrooms: 1,
    sleeps: 6,
    ...
    href: "https://seaandcityrentals.hospitable.rentals/",
    directBookingUrl:
      "https://seaandcityrentals.hospitable.rentals/listings/d60f44e9-181c-5c24-b9ca-ebf65a8d776e",
    ...
    amenities: [
      "Game room with dartboard",
      "Statement art throughout",
      "Open plan living",
      "King + sofa bed + futon",
      "Updated kitchen",
      "Walk to downtown",
