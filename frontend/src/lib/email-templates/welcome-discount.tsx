  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={body}>
          <Text style={text}>
            Thanks for joining the {SITE_NAME} list. As promised, here's your code
            for 10% off any direct booking — no Airbnb fees, no markup.
          </Text>
          ...
          <Text style={text}>
            Apply the code at checkout when you book direct. Questions? Just reply
            to this email — we read every message.
          </Text>
